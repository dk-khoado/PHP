                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a href="<?php echo site_url("Api/signOut") ?>" onclick="return confirmDelete()"><button class="nav-link fas fa-power-off btn"></button></a>                        
                        </li>
                    </ul>
                </div>
            </nav>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url('admin/index') ?>">E Commerce Dashboard</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url('admin/product') ?>">Product List</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url('admin/Order') ?>">Product Checkout</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>      
                            <li class="nav-item ">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url('admin/accout') ?>">Nhân Viên</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url('admin/CustomerAccout') ?>">Khách hàng</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url('admin/ViewCart') ?>">Quản lý khu vực</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>                        
