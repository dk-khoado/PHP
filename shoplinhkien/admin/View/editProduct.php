...
$mySQl = new MySQL();
$ID = $_GET['id'];
$Product = $mySQl->SelectProduct($ID);
?>
...
<body class="container-fluid">
	<div class="row">
		...
		<div class="col-xl-10 ">
			<!--HIỆN NÔI DUNG-->
			<form class="mt-4 shadow mx-5 mt-5" action="../controller/updateProduct.php" method="POST" enctype="multipart/form-data">
				<table class="table table-borderless">
					<tr>
						<td rowspan="3">
							...
							<img id="image" src="<?php echo $Product['Image'] ?>" height="200px" width="200px">
					...
					<tr>
						<td><button class="btn btn-success w-100" type="submit" name="ID" value="<?php echo $Product['ID_PRODUCT'] ?>">Cập Nhập</button></td>
